...
<b ><font color="red" ><h2 >Create Admin Profile</h2></font></b>
<hr size="2px" color="black" width="400px"></br>
<table>
<form action="http://localhost:8080/LibraryManagement1/createadmin" method="post">
<tr >
<td><b><i>AdminId</i></td>
<td><input type="number" name="aid" placeholder="Enter the AdminId" required class=f5></td>
</tr>
<tr>
<td><b><i>FirstName</td>
