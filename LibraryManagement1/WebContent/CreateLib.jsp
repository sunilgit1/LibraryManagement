...
<b ><font color="red" ><h2 >Create Librarian Profile</h2></font></b>
<hr size="2px" color="black" width="400px"></br>
<table>
<form action="http://localhost:8080/LibraryManagement1/createprofile" method="post">
<tr >
<td><b><i>LibId</i></td>
<td><input type="number" name="lid" placeholder="Enter the LibrarianId" required class=f5></td>
</tr>
<tr>
<td><b><i>FirstName</td>
